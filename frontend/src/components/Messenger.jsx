...
import { IoLogOutOutline } from "react-icons/io5"; // Assuming you're using Io5
...
const Messenger = () => {
  ...
  useEffect(() => {
    ...
    console.log("socketMessage",socketMessage)
     useEffect(() => {
       if (socketMessage !== "") {
         localStorage.setItem("socketMessage", JSON.stringify(socketMessage));
       }
     }, [socketMessage]);
      ...
      <div className="row">
        ...
        {currentfriend ? (
          <RightSide
            ...
            ImageSendUpload={ImageSendUpload}
